 ...
 if(isset($_POST['submit']))
 {
   ...
   $sub = mysqli_real_escape_string($db,$_POST['sel1']);
        $qu = "SELECT testid,testname FROM test WHERE testsub='$sub' ";
        ...
        if($nR<1)
        {
            header("Location: exam.php?no_test_found_for_subject_choosen");
            exit();
        }
        else
        {
            $_SESSION['storingdata']=$sub;
         header("Location: exam1.php?choose_test");
         exit();
        }
 }
