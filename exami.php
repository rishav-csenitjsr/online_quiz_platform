 ...
 if(isset($_POST['submit']))
 {
   ...
   $_SESSION['mystream']=$tst;
   header("location: exami1.php?select_test_name");
     ...
     <div class="form-group">
      ...
      <?php
        include ("config.php");
         ...
         $hello="SELECT r.sname FROM student t,subject r WHERE t.strm=r.sbranch AND t.username='$hi' ";
      ...
      ?>
         ...
         <button type="submit" name="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Start Test</button>
        </form>
     </div>
        <div class="col-sm-4">
        </div>
